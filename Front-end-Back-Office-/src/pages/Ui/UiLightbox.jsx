...
const UiLightbox = (props) => {
  const selectedPlace = {};
  // Load Google Maps JS API (replaces the older `google-maps-react` wrapper)
  const apiKey = "AIzaSyAbvyBxmMbFhrzP9Z8moyYr6dCr-pzjhBE";
                          ...
                          >
                            {isLoaded ? (
                              <GoogleMap
                                ...
                                // Default center changed to New Delhi, India (en-IN defaults)
                                center={{ lat: 28.6139, lng: 77.2090 }}
                                zoom={14}
                              >
                                <InfoWindow position={{ lat: 28.6139, lng: 77.2090 }}>
                                  <div>
                                    <h1>{selectedPlace.name || "Location"}</h1>
                                  </div>
                                </InfoWindow>
                              </GoogleMap>
                            ) : (
