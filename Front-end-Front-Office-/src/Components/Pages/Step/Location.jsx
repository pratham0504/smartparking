                  ...
                  <div className="p-4">
                    ...
                    <div className="flex flex-col gap-2 relative z-10">
                      ...
                      <button
                        ...
                        className="w-full bg-green-500 text-black py-2 px-4 rounded-lg hover:bg-green-600 transition-colors text-sm font-medium cursor-pointer flex items-center justify-center gap-2"
                      >
                        <svg 
                          xmlns="http://www.w3.org/2000/svg" 
                          className="h-5 w-5" 
