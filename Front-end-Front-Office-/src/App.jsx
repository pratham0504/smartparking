          ...
          <NotificationProvider>
            ...
            <Routes>
              <Route path="/" element={<DefaultLayout />}>
                ...
                <Route path="rfid-management" element={<PrivateRoute><RFIDManagement /></PrivateRoute>} />
                ...
                <Route 
                  path="ScanQr" 
                  element={
                    <PrivateRoute allowedRoles={['Employe', 'Employee']}>
                      <EmployeeProfile />
                    </PrivateRoute>
                  }
                />
                <Route 
                  path="my-parkings" 
                  element={
                    <PrivateRoute allowedRoles={['Owner', 'Space_Owner']}>
                      <ParkingListOwner />
                    </PrivateRoute>
                  }
                />
                ...
                <Route 
                  ...
                  element={
                    <PrivateRoute allowedRoles={['Driver', 'Vehicle_Owner']}>
                      <ListSubsDriver />
                    </PrivateRoute>
                  }
                />
                <Route 
                  ...
                  element={
                    <PrivateRoute allowedRoles={['Owner', 'Space_Owner', 'Admin']}>
                      <PeakHoursDashboard />
                    </PrivateRoute>
                  }
                />
